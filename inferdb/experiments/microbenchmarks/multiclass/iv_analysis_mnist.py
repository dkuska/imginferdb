...
model = xgb.XGBClassifier(
    objective="multi:softmax", num_class=10, random_state=42, n_jobs=-1
)
...
X_train_encoded = encoder.transform_dataset(
...
for i in range(10):
    ...
    problem = Problem(
        X_train_encoded, y_pred_train, encoder.num_bins, "classification", 1
    )
