...
def nyc_experiment(featurizer, model, batch_sizes):
    ...
    tuples, encoder, features_names, solution = test.get_kv_tuples(
        pipeline, "db", path, "trip_duration", False
    )
    ...
    for b in batch_sizes:
        ...
        test.create_featurizer(
            pickup_encoder, dropoff_encoder, clusters_encoder, route_freq_dict, b
        )
