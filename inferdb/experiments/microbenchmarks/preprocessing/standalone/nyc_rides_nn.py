...
def nyc_rides_nn():
    ...
    for i in range(5):
        ...
        pipeline_path = os.path.join(
            project_folder, "objects", "nyc_rides_mlpregressor_complex_pipeline.joblib"
        )
        object_path = os.path.join(
            project_folder,
            "objects",
            "nyc_rides_mlpregressor_complex_experiment.joblib",
        )
    ...
    save_path = os.path.join(
        exp_folder, "experiments", "output", test.name + "_" + "mlpregressor"
    )
